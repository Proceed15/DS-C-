...
namespace WfaVendas
{
    public partial class Produtos : Form
    {
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(null, "Selecione um produto primeiro!", "Erro:", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (alterar)
                {
                    //pc_produtoTableAdapter.Update(Int32.Parse(txtQuant.Text), txtDescri.Text, Int32.Parse(mskPrecounit.Text), Convert.ToInt32(txtCodpro.Text));
